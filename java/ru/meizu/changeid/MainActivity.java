    ...
    if (android.os.Build.MANUFACTURER.equals("Meizu")) {
     ...
     switch (android.os.Build.MODEL) {
      ...
      case "M2 mini":
       ...
       sudo("echo -e '5' | dd of=/dev/block/mmcblk0p1 bs=1 seek=141 count=1 conv=notrunc");
       sudo("echo -e '1' | dd of=/dev/block/mmcblk0p1 bs=1 seek=145 count=1 conv=notrunc");
       break;

      case "M5 Note":
       sudo("dd if=/dev/block/mmcblk0p28 of=/sdcard/devinfo_backup_$(date +%Y-%m-%d).img");
       sudo("echo -e '5' | dd of=/dev/block/mmcblk0p28 bs=1 seek=515 count=1 conv=notrunc");
       break;

      case "M6 Note":
       sudo("dd if=/dev/block/mmcblk0p50 of=/sdcard/devinfo_backup_$(date +%Y-%m-%d).img");
       sudo("echo -e '5' | dd of=/dev/block/mmcblk0p50 bs=1 seek=515 count=1 conv=notrunc");
       sudo("echo -e '2' | dd of=/dev/block/mmcblk0p50 bs=1 seek=519 count=1 conv=notrunc");
       break;

      case "PRO 5":
       sudo("dd if=/dev/block/platform/15570000.ufs/by-name/proinfo of=/storage/emulated/0/devinfo_backup_$(date +%Y-%m-%d).img");
       sudo("echo -e 'intl_official' | dd of=/dev/block/platform/15570000.ufs/by-name/proinfo bs=1 seek=44 count=13 conv=notrunc");
       break;

      case "PRO 6":
       sudo("dd if=/dev/block/mmcblk0p4 of=/sdcard/devinfo_backup_$(date +%Y-%m-%d).img");
       sudo("echo -e '5' | dd of=/dev/block/mmcblk0 bs=1 seek=568885765 count=1 conv=notrunc");
       sudo("echo -e '1' | dd of=/dev/block/mmcblk0 bs=1 seek=568885769 count=1 conv=notrunc");
       break;
      ...
      case "M5s":
       ...
       sudo("echo -e '5' | dd of=/dev/block/mmcblk0p18 bs=1 seek=517 count=1 conv=notrunc");
       break;

      case "M5":
       sudo("dd if=/dev/block/mmcblk0p8 of=/sdcard/devinfo_backup_$(date +%Y-%m-%d).img");
       sudo("echo -e '5' | dd of=/dev/block/mmcblk0p15 bs=1 seek=517 count=1 conv=notrunc");
       sudo("echo -e '2' | dd of=/dev/block/mmcblk0p15 bs=1 seek=521 count=1 conv=notrunc");
       break;

      case "M6":
       sudo("dd if=/dev/block/mmcblk0p8 of=/sdcard/devinfo_backup_$(date +%Y-%m-%d).img");
       sudo("echo -e '5' | dd of=/dev/block/mmcblk0p8 bs=1 seek=515 count=1 conv=notrunc");
       sudo("echo -e '2' | dd of=/dev/block/mmcblk0p8 bs=1 seek=519 count=1 conv=notrunc");
       break;
      ...
      case "MX6":
       ...
       sudo("echo -e '5' | dd of=/dev/block/mmcblk0p16 bs=1 seek=517 count=1 conv=notrunc");
       break;
      ...
      case "U20":
       sudo("dd if=/dev/block/mmcblk0p28 of=/sdcard/devinfo_backup_$(date +%Y-%m-%d).img");
       sudo("echo -e '5' | dd of=/dev/block/mmcblk0p28 bs=1 seek=517 count=1 conv=notrunc");
       break;
